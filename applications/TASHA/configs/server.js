...
export default {
    ...
    sparqlEndpoint: {
        ...
        //TASHA MicroSim Repository endpoint
       // 'http://35.183.207.17:10035/repositories/tasha_sample':{
       //   host:'35.183.207.17', port:10035, path:'/repositories/tasha_sample/sparql',graphName:'default', endpointType:'allegrograph'
       // },
        'http://35.183.10.206:10035/repositories/tasha_sample':{
          host:'35.183.10.206', port:10035, path:'/repositories/tasha_sample',graphName:'default', endpointType:'allegrograph'
        },
